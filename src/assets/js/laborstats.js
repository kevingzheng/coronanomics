...
let u_info = {
  default:
    "Click on a line in the graph to learn more about the country's labor statistics.",

  usa:
    "<h1 class = 'paragraph-size'>US Unemployment Information (<span class = 'triangle-top'></span>" +
  ...
  japan:
    "<h1 class = 'paragraph-size'>Japan (<span class = 'triangle-top'></span>" +
  ...
  germany:
    "<h1 class = 'paragraph-size'>Germany (<span class = 'triangle-bottom'></span>" +
  ...
  unitedkingdom:
    "<h1 class = 'paragraph-size'>United Kingdom (<span class = 'triangle-bottom'></span>" +
    "<span class = 'green-text'>+0.1%</span> from April 2020)</h1>" +
    "<hr class = 'h-line'>" +
    "<br>" +
    "<p class = 'unemployment-paragraph'>" +
  ...
  france:
    "<h1 class = 'paragraph-size'>France (<span class = 'triangle-bottom'></span>" +
    "<span class = 'green-text'>+0.1%</span> from April 2020)</h1>" +
    "<hr class = 'h-line'>" +
    "<br>" +
    "<p class = 'unemployment-paragraph'>" +
...
////////////////////////////////
let usacsv =
  "https://raw.githubusercontent.com/kevingzheng/coronanomics/master/src/assets/data/unemployment_country/unemployment_1990_2020_bls_conv.csv";
let japancsv =
  "https://raw.githubusercontent.com/kevingzheng/coronanomics/master/src/assets/data/unemployment_country/japan.csv";
let francecsv =
  "https://raw.githubusercontent.com/kevingzheng/coronanomics/master/src/assets/data/unemployment_country/france.csv";
let germanycsv =
  "https://raw.githubusercontent.com/kevingzheng/coronanomics/master/src/assets/data/unemployment_country/germany.csv";
let unitedkingdomcsv =
  "https://raw.githubusercontent.com/kevingzheng/coronanomics/master/src/assets/data/unemployment_country/unitedkingdom.csv";

////////////////////////////////
////////////////////////////////
// Load unemployment graph
var svg = d3
  .select("#unemployment-graph")
  .append("svg")
...
function unclickAllOthers() {
  for (let i = 0; i < countryIds.length; i++) {
    if (u_clicked[countryIds[i]] === true) {
      d3.select("#" + countryIds[i] + "-data").attr(
        "stroke",
        "url(#line-gradient"
      );
